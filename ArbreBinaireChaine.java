...
public class ArbreBinaireChaine<N> implements ArbreBinaire<N> {
	
	public static final ArbreBinaire arbreBinaireVide = new ArbreBinaireChaine();
	protected N val;
	...
	public ArbreBinaireChaine(N e , ArbreBinaire<N> g , ArbreBinaire<N> d ) {
		val = e;
		sag = g==null?arbreBinaireVide:g;
		sad = d==null?arbreBinaireVide:d;
	}
	
	public ArbreBinaireChaine(N e){
		val=e;
	...
	public ArbreBinaire<N> créerMiroir(){
		return estVide()?this: new ArbreBinaireChaine(val,sad.créerMiroir(),sag.créerMiroir());
	}
